...
import os
import pyodbc
import logging # trazabilidad
import json #formatear salidas
import asyncio #llamas asincronas para esperar que la ejcuion termine cuando el server devuelva una respuesta
